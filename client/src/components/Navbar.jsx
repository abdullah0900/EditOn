        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              ...
              <NavLink
                to="/creator"
                className="block px-8 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white"
              >
                Creators
              </NavLink>
              <NavLink
                to="/movies"
                className="block px-2 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white"
              >
                Movies
              </NavLink>
            </div>
          ...
          {!auth?.user ? (
            ...
            <div className="invisible sm:visible">
              <div className="flex gap-3 mt-3">
                {/* {profileToggle || (auth?.user?.userType != "client" &&
                  ...
                  {
                    (!profileToggle) && <div className="flex gap-3 mt-0">
                    <NavLink
                      to="/myvideos"
                      className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white"
                    >
                ...
                <Profile onClick={handleLogout} auth={auth} handleProfile={handleProfile}/>
              </div>
            </div>
          )}
        </div>
