...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_NODE_API}api/v1/auth/register`,
        {
          name,
          email,
          // profession,
  ...
  const handleGoogleSignUp = () => {
    ...
    // You can redirect the user to Google OAuth or use any other method
  };
  ...
  return (
    ...
    justify-around items-center"
      ...
      {/* </div> */}
      <div
        className="flex md:w-1/2 justify-center py-10 items-center bg-gray-800"
        id="padding"
      >
        <form className="bg-gray-800 px-3" onSubmit={handleSubmit}>
          <h1 className="text-white font-bold text-3xl mb-1 text-center">
            Register
          </h1>
          <p className="text-lg font-normal text-white mb-4 text-center">
            ...
            <input
                ...
                onChange={(e) => {
                  ...
                  if (!/\d/.test(inputValue)) {
                    ...
                    // Display an error or handle the invalid input as needed
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
       ...
       */}
          ...
          <button
            type="submit"
            className="block w-full bg-purple-400 mt-4 py-2 rounded-2xl text-white font-semibold mb-2 hover:bg-indigo-800"
          >
            Register
          </button>
          {/* <p style={{ marginLeft: 120, color: "white" }}> OR</p> */}
          {/* <button
        onClick={handleGoogleSignUp}
        className="block w-full bg-red-600 mt-4 py-2 rounded-2xl text-white font-semibold hover:bg-red-800 flex items-center justify-center"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth="2"
            d="M12 6c-2.481 0-4.63.89-6.364 2.384A9.98 9.98 0 001 12c0 5.523 4.477 10 10 10 5.523 0 10-4.477 10-10 0-5.523-4.477-10-10-10z"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
