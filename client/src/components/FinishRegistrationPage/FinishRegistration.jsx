  ...
  const countries = [
    {
      value: "Pakistan",
      label: "PK",
      cities: ["Sargodha", "Faislabad", "Lahore", "Islamabad", "Rawalpindi", "Karachi", "Chiniot", "Pehsawar", "Quetta"],
      state: ["Punjab", "Sindh", "Balochistan", "KPK"],
    }
    // {
    //   value: "United States of America",
    //   label: "USA",
    //   cities: ["New York", "Manhattan", "Washington DC", "Islamabad"],
